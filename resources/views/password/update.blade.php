...
<div class="app-brand justify-content-center">
    <span class="app-brand-text  demo text-body fw-bolder">Update Password</span>
</div>
<!-- /Logo -->
<p class="mb-4">Please type your old & new password to Update.</p>
...
<form id="formAuthentication" class="mb-3" action="{{ route('password.update.next') }}" method="POST">
    ...
    <div class="mb-3 form-password-toggle">
        <div class="d-flex justify-content-between">
            <label class="form-label" for="old_password">Old Password</label> @error('old_password') <span class="small text-danger">{{$message}}</span> @enderror
        </div>
        <div class="input-group input-group-merge">
            <input type="password" id="old_password" class="form-control" name="old_password" placeholder="Enter your old Password" aria-describedby="password" />
